...
public class MicChoosePanel extends JPanel {
	...
	public static final String KEY_CHOOSE_MIC = "chooseMic";
	
	public MicChoosePanel(){
		...
		public void actionPerformed(ActionEvent arg0) {
			for(Mixer.Info info : Shared.getMixerInfo(false, true)){
				if(arg0.getActionCommand().equals(info.toString())){
					...
					MicChoosePanel.this.firePropertyChange(KEY_CHOOSE_MIC, mixer, newValue);
					MicChoosePanel.this.mixer = newValue;
					break;
				}
			}
		}
